...
local dialogue = {
    {'normal',"you see, i can't judge the book by its cover but..."},
    {'gay','i know what happened with you and that cup guy.'},
    {'closed',"i'd if you try to do the same with me..."},
    {'funny',"things wont turn out so well."},
    {'normal','up to you kid....'},
    {'noeyes','no pressure.'}
}
function onCreate()
